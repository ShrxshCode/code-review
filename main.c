...
/*
 * Take the contents of a file and convert it to base64 or uuencoded
 * format, and also convert from base64 or uuencoded format back to the
 * original contents.
 */
int
main(int argc, char **argv)
{
    ...
    /* Check the number of command line arguments and exit on an error. */
    if (argc != 4) {
        Usage();
        exit(1);
    }
